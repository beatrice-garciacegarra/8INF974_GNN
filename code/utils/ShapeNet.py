...
class ShapeNet(InMemoryDataset):
    ...
    Args:
        ...
        categories (string or [string], optional): The category of the CAD
            modelsLocal (one or a combination of :obj:`"Airplane"`, :obj:`"Bag"`,
    ...
    def __init__(self, root, categories=None, include_normals=True,
        ...
        self.y_mask = torch.ones((len(self.seg_classes.keys()), 1),
                                  dtype=torch.bool)
    ...
    def process_filenames(self, filenames):
        ...
        for name in filenames:
            ...
            y = torch.tensor([indexswap[int(data[0, -1])]]).type(torch.long)
            #print(y)
